...
class MealSelectionViewModel: ObservableObject {
    ...
    func storeSelectedMeals(selectedMeals : Set<String>){
        ...
        var nOfUser = 0
        var breakfast = selectedMeals.joined(separator: ", ")
...
struct BreakfastSelectView: View {
    ...
    @State private var selectedMealStates: [String: Bool] = [:]
                ...
                VStack(spacing:0){
                                ...
                                ExpandableView(thumbnail: ThumbnailView {
                                    ...
                                    VStack(alignment: .leading, spacing: 0) {
                                        ...
                                        HStack(){
                                            ...
                                            Text(meal)
                                                .foregroundColor(selectedMealStates[meal, default: false] ? .teal : .black)
                                                .padding(.leading,20)
                                                .padding(.vertical)
                                                .font(.system(size:19))
                                           ...
                                           // .background(selectedMealStates[meal, default: false] ? Color.blue : Color.gray)
                   ...
                   /* Text("Selected meals: \(viewModel.selectedMeals.joined(separator: ", "))")
                    ...
                    VStack{
                        ...
                        //.opacity(viewModel.selectedMeals.count <= 3 ? 0 : 1)
                        .cornerRadius(10)
                        .padding(EdgeInsets(top: 0, leading: 300, bottom: 5, trailing: 20))
                    }
                    .background(Color("Color1"))

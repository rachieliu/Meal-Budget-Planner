...
struct MealDetailsView: View {
    @Environment(\.presentationMode) var mode: Binding<PresentationMode>
        @State var meaItemModel: MealItemModel
        ...
        var body: some View {
            ...
            VStack {
                ...
                Rectangle()
                    ...
                    .foregroundColor(Color.fromHex(mealItemModel.accentColor))
                    .frame(height: 0)
                ...
                VStack {
                    ...
                    ScrollView(.vertical, showsIndicators: false){
                        ...
                        URLImage(URL(string: meaItemModel.image)!,
                                 placeholder: { _ in
                                    Image("kiwi")
                                        .resizable()
                                        .scaledToFit()
                        ...
                        ZStack {
                            ...
                            VStack {
                                ...
                                Text(meaItemModel.quantityDesc ?? "")
                                    .font(.subheadline)
                                    .fontWeight(.semibold)
                                    .lineLimit(1)
                                    .padding([.top, .leading])
                                ...
                                Text(meaItemModel.description ?? Constants.LOREUM_TEXT)
                                    .font(.subheadline)
                                    .fontWeight(.semibold)
                                ...
                                HStack {
                                    ...
                                    Text(Utils.getFormattedPrice(price: meaItemModel.price))
                                        .font(.title)
                                        .fontWeight(.semibold)
                                        .lineLimit(1)
                                        .padding(.trailing)
            ...
            }.background(Color.fromHex(self.meaItemModel.accentColor))
                .padding(.top, -10)
        }
...
struct MealDetailsView_Previews: PreviewProvider {
    static var previews: some View {
        MealDetailsView(meaItemModel: LocalDataHandler.productsData[2])
    }
}
